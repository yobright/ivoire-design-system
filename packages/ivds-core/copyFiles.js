 ...
 * The prefix part of the glob pattern (before first asterisk) is replaced with target path.
 ...
 * Args:
 *  - "-s" or "--source" path to scan. It is a glob pattern. Example: 'src/components/star-star/star.scss'.
...
/**
 * Create the path for a file if it does not exist
 */
